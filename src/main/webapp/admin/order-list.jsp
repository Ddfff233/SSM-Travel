            ...
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn"
                            onclick="xadmin.open('添加用户','${pageContext.request.contextPath}/admin/order-add.jsp',600,400)">
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            <c:forEach var="u" items="${landTickets}">
                        <tr data-id=${u.landTicketId}>
                            <td>
                                <input type="checkbox" name="id" value="2" lay-skin="primary">
                            </td>
                            <td>${u.landTicketId}</td>
                            <td>${u.landName}</td>
                            <td>${u.uid}</td>
                            <td>${u.date}</td>
                            <td>${u.time}</td>
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑"
                                   onclick="xadmin.open('编辑','${pageContext.request.contextPath}/admin/order-edit.jsp?id='+${u.uid},)"
                                   href="javascript:;">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>
    ...
    function member_del(element) {
        ...
        if (id) {
            layer.confirm('确认要删除吗？', {icon: 3, title: '提示'}, function (index) {
                // 发送Ajax请求到服务器删除数据
                $.ajax({
                        url: '${pageContext.request.contextPath}/admin/deletelandTickert', // 替换为你的删除API地址
