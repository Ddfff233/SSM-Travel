        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加用户','${pageContext.request.contextPath}/admin/member-add.jsp',600,400)"><i class="layui-icon"></i>添加</button>
                </div>
                        ...
                        <tr>
                            <c:forEach var="u" items="${userList}">
                                ...
                                <td class="td-manage">
                                    ...
                                    <a title="编辑"  onclick="xadmin.open('编辑','${pageContext.request.contextPath}/admin/member-edit.jsp?id='+${u.uid},600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
    ...
    function member_del(element) {
        ...
        if (id) {
            layer.confirm('确认要删除吗？', {icon: 3, title:'提示'}, function(index){
                // 发送Ajax请求到服务器删除数据
                $.ajax({
                    url: '${pageContext.request.contextPath}/admin/delete', // 替换为你的删除API地址
